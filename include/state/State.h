...
public:
    ...
    detectVertexConflicts(const int &time_step, const std::map<int, Position> &agents_goal);
    ...
    bool isStateTerminalForAnyAgent(const std::map<int, Position> &agents_goal) const;
};
